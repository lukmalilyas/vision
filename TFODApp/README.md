...
aws s3api put-bucket-cors --bucket visioncookingapplcation --cors-configuration file://corsconfig.json


https://visioncookingapplcation.s3.ap-south-1.amazonaws.com/model.json
